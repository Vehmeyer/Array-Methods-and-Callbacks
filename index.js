...
function getYears(data, getFinalscb) {
    let finalStageTeamsYears = getFinalscb;
    finalStageTeamsYears = data.map(function(item){
        return item.Year;
    })
    return finalStageTeamsYears;
}

console.log('task3', getYears(getFinals(fifaData)));
